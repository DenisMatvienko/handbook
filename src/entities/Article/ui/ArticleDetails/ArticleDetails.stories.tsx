...
export const ArticleDetailsIsLoading = Template.bind({});
ArticleDetailsIsLoading.args = {};
ArticleDetailsIsLoading.decorators = [StoreDecorator({
  articleDetails: {
    isLoading: true,
  },
})];
...
ArticleDetailsError.decorators = [StoreDecorator({
  articleDetails: {
    error: 'error',
  },
})];
