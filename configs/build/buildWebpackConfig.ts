    ...
    return {
        ...
        devtool:
            /* https://webpack.js.org/guides/development/#using-source-maps 
                ...
                into one bundle (bundle.js) and one of the source files contains an error, the stack trace will point to bundle.js
            */
            isDev
                ? 'inline-source-map' // add source-maps in dev build
                : undefined, // remove source-maps from prod build
        devServer: isDev ? buildDevServer(options) : undefined, // dev-server run just in dev build. prod build - didn't
