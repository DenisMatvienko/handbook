...
export default {
  ...
  // When we are importing with absolute path, we catch error 'cannot find module', this
  // config fix that
  modulePaths: [
    '<rootDir>src',
  ...
  testMatch: [
    // universal regexp, working on macOS & win, default reg didn't work on macOS
  ...
  // correct modules.scss error when run test
  moduleNameMapper: {
    // css, scss mapper
    '\\.s?css$': 'identity-obj-proxy',
    // svg mapper for svg extensions errors in jest
  ...
  // cacheDirectory: "C:\\Users\\kater\\AppData\\Local\\Temp\\jest",
